...
from phishing.util.util import load_numpy_array_data,load_data, save_object, load_object
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self)->ModelTrainerArtifact:
        try:
            ...
            trained_model_file_path=self.model_trainer_config.trained_model_file_path
            phishing_model = PhishingEstimatorModel(preprocessing_object=preprocessing_obj,trained_model_object=model_object)
            logging.info(f"Saving model at path: {trained_model_file_path}")
            save_object(file_path=trained_model_file_path,obj=phishing_model)

            model_trainer_artifact=  ModelTrainerArtifact(is_trained=True, message="Model Trained successfully", trained_model_file_path=trained_model_file_path,
